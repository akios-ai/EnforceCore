"""Post-release pip install test for enforcecore==1.0.24a1."""
...
def t0():
    ...
    assert enforcecore.__version__ == "1.0.24a1", f"Got {enforcecore.__version__}"
...
print("Package: enforcecore==1.0.24a1 from PyPI")
print("=" * 55)
