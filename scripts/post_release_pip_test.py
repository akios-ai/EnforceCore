"""Post-release pip install test for enforcecore==1.0.0b2."""
...
def t0():
    ...
    assert enforcecore.__version__ == "1.0.0b2", f"Got {enforcecore.__version__}"
...
print("Package: enforcecore==1.0.0b2 from PyPI")
print("=" * 55)
